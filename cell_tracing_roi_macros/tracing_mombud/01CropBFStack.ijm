/*This macro crops out individual 250x250 BF cell stacks 
for individual cell ROIs */
...
run("Close"); 
_xy = 250;
/*Choose the directory where the full size BF stacks
 * are located */
...
/*Full size focal slice stack where labels for ind. cells
will be cropped out*/
open("zBFfocal.tif");
MAXP = getImageID;
print(MAXP);
